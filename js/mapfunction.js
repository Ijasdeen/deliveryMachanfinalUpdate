//set map options
var myLatLng = { lat: 7.857685, lng: 78.4650391 };
var mapOptions = {
    center: myLatLng,
    zoom: 7,
...
function calcRoute() {
  ...
  $("#allarea").html("<div class='alert-info'>From: " + document.getElementById("from").value + ".<br />To: " + document.getElementById("to").value + ".<br /> Driving distance: " + result.routes[0].legs[0].distance.text + ".<br />Duration: " + result.routes[0].legs[0].duration.text + ".</div>");
 ...
 //We are going to do the same level;
}
