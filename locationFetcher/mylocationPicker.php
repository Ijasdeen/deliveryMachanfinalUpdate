...
$long = mysqli_real_escape_string($connection,$_GET['long']);
        ...
        <div class="container-fluid">
            ...
            <form class="form-horizontal">
                <div class="form-group">
                    ...
                    <div class="col-xs-10">
                        <input type="text" id="from" placeholder="Origin" class="form-control" value="<?php echo $totalLong;?>" disabled>
                    </div>
                </div>
                <div class="form-group">
                    <label for="to" class="col-xs-2 control-label">To:</label>
                    <div class="col-xs-10">
                        <input type="text" id="to" placeholder="Destination" class="form-control" value="7.284121,80.639679" disabled>
                    </div>
                </div>
            </form>
